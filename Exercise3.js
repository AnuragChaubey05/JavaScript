...
<html>
  ...
  <body>
    ...
    <div class="container py-4 px-4 ">
      ...
      <div class="card">
        <div class="card-body">
          <p id="joke" class="joke" name="joke">click the button for a random joke</p>
        </div>
      </div>
      
      <button onclick="randomJokes()"  type="button" class="btn btn-outline-dark my-3">
        Joke 
    </button>
